        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppearanceDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterStory", x => new { x.CharactersId, x.StoriesId });
                    table.ForeignKey(
                        name: "FK_CharacterStory_Characters_CharactersId",
                        column: x => x.CharactersId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterStory_Stories_StoriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterStory_StoriesId",
                table: "CharacterStory",
                column: "StoriesId");
